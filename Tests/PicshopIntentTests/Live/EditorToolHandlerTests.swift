...
@MainActor private enum HandlerScenarios {
    ...
    static func testUndoCompareAndIdeas() async throws {
        ...
        let good = LiveIdea(title: "Noir et blanc", why: "Graphique.", symbol: nil, steps: [RawIntentStep(action: "applyLook", look: "mono")], source: .model)
    ...
    static func testIdeasAndPlans() async throws {
        ...
        let invalid = LiveIdea(title: "Couper", why: "", symbol: nil, steps: [RawIntentStep(action: "split", seconds: 2)], source: .model)
