...
| Traduis les sous-titres en anglais · Translate the captions to Spanish | On-device translation (Apple Translation); each line keeps its time |
...
| Ajoute des zooms de coupe · Zoom cuts · Enlève les zooms de coupe | After jump cuts, every other segment framed tighter on the speaker's face |
...
Mets-moi sur une plage au coucher du soleil · Put us in Paris · Floute les visages · Floute la plaque · Enlève les passants · Clean up the photo ·
