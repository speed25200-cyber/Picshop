...
public enum ObjectVocabulary {
    ...
    public static let entries: [Entry] = [
        ...
        Entry(label: "sign", spoken: ["sign", "signs", "panneau", "panneaux", "pancarte", "pancartes", "billboard", "affiche", "affiches", "poster", "posters", "signpost", "plaque", "banner", "banniere", "number plate", "number plates", "license plate", "licence plate", "license plates", "licence plates", "plaque immatriculation", "plaques immatriculation", "plaque d immatriculation", "plaque mineralogique", "immatriculation", "numero plaque", "numero de plaque", "numero de la plaque"], classifierTerms: ["sign", "signboard", "billboard", "poster", "street sign", "traffic sign", "banner", "placard"], category: .object),
...
public enum ParameterVocabulary {
    ...
    static let table: [(String, AdjustmentParameter, Int)] = [
        ...
        // Subjective and photographic vocabulary ("it looks dull", "the light is harsh", "c'est jaunâtre")
        ("saturated", .saturation, 0), ("saturee", .saturation, 0), ("oversaturated", .saturation, -1), ("sursaturee", .saturation, -1), ("sursature", .saturation, -1),
        ("desaturated", .saturation, -1), ("dull", .vibrance, 1), ("bland", .vibrance, 1), ("lifeless", .vibrance, 1), ("sans vie", .vibrance, 1), ("fadasse", .vibrance, 1),
        ("eteint", .vibrance, 1), ("eteinte", .vibrance, 1), ("eteintes", .vibrance, 1), ("pale", .saturation, 1), ("harsh", .highlights, -1), ("too harsh", .highlights, -1),
        ("harsh light", .highlights, -1), ("lumiere dure", .highlights, -1), ("trop dure", .highlights, -1), ("blown", .highlights, -1), ("muddy", .blacks, -1),
        ("boueux", .blacks, -1), ("boueuse", .blacks, -1), ("crushed", .blacks, 1), ("bouches", .blacks, 1), ("yellowish", .temperature, -1), ("jaunatre", .temperature, -1),
        ("orangey", .temperature, -1), ("orangeatre", .temperature, -1), ("bluish", .temperature, 1), ("bleuatre", .temperature, 1), ("greenish", .tint, 1), ("verdatre", .tint, 1),
        ("gloomy", .brightness, 1), ("morne", .brightness, 1), ("lighting", .brightness, 0), ("eclairage", .brightness, 0), ("lumiere", .brightness, 0),
        ("whiten", .brightness, 1), ("blanchis", .brightness, 1), ("blanchir", .brightness, 1), ("glow", .highlights, 1), ("glowy", .highlights, 1),
        // Effects
