...
public enum IntentAction: String, Codable, Sendable, CaseIterable {
    ...
    public var isVideoOnly: Bool {
        ...
        case .trim, .split, .deleteClip, .deleteRange, .setSpeed, .reverse, .mute, .unmute, .setVolume,
             ...
             .duplicateClip, .moveClip, .stabilize, .freezeFrame, .autoCaptions, .removeCaptions, .removeSilences, .removeFillers, .cutWords, .autoDuck, .trackSubject, .splitScenes, .animateText, .highlights, .syncToBeat,
    ...
    public var isPhotoOnly: Bool {
        switch self {
        case .selectLayer, .duplicateLayer, .deleteLayer, .upscale, .relight, .generativeFill, .recolor, .describe, .saveStyle, .applyStyle, .expandCanvas, .moveObject: return true
